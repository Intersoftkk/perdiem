    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView
        ...
        <View
          ...
          {this.props.route.params &&
            this.props.route.params.item.body &&
            this.props.route.params.item.body != '' && (
              <Text style={[styles.itemBodyStyle, {width: '100%'}]}>
                {this.props.route.params.item.body}
              </Text>
            )}
        </View>
      ...
      <RBSheet
        ...
        <RBSheetContent
          ...
          focusTodo={() =>
            this.setState(
              {todoFocused: true, postFocused: false, todos: [], posts: []},
              () =>
                this.props.navigation.navigate('HomeScreen', {
                  todoFocused: true,
                  postFocused: false,
          ...
          focusPosts={() =>
            this.setState(
              {todoFocused: false, postFocused: true, todos: [], posts: []},
              () =>
                this.props.navigation.navigate('HomeScreen', {
                  todoFocused: false,
                  postFocused: true,
