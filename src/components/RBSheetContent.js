...
export default class RBSheetContent extends React.Component {
    ...
    render = () => (
        <View
            style={[styles.footerStyle, this.props.additionalStyle ? this.props.additionalStyle : {}, {flexDirection: this.props.rbSheet ?  'column' : 'row'}]}
        >
            <TouchableOpacity
                activeOpacity={0.7}
            ...
            >
                {
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center', width: '100%'}}> 
                        <VectorIcons
                            name={this.props.todoFocused ? "radio-button-on-outline" : "radio-button-off-outline"}
                            size={30}
                            color="#017bff"
                        />
                        <Text
            ...
            >
                {
                    ...
                    <View style={{flexDirection: 'row', alignItems: 'center', width: '100%'}}> 
                        <VectorIcons
                            name={this.props.postFocused ? "radio-button-on-outline" : "radio-button-off-outline"}
                            size={30}
                            color="#017bff"
                        />
                        <Text
